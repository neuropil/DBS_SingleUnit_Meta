...
setCheckFiles = cellstr(ls('*.mat'));

% Check for multiple Tracks = 'Sets'
if strcmp(setCheckFiles,'')

    setChoose = questdlg('Choose Set','Set?','Set1','Set2','Set1');
    
    setLoc = strcat(pwd,'\',setChoose);
