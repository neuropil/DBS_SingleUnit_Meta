function Relabel_AO_Depth_Beta
...
if doneTag == 0
    ...
    for abi = 1:height(abvOutT)
        ...
        abnewFname = [newLoc,'\',abvOutT.abDSName{abi},'_',num2str(abi),'_',abvOutT.abDSDepthAct{abi},'.mat'];
    ...
    for bli = 1:height(blwOutT)
        ...
        blnewFname = [newLoc,'\',blwOutT.blDSName{bli},'_',num2str(bli),'_',blwOutT.blDSDepthAct{bli},'.mat'];
