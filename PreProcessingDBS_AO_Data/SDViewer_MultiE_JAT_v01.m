function varargout = SDViewer_MultiE_JAT_v01(varargin)
% SDVIEWER_MULTIE_JAT_V01 MATLAB code for SDViewer_MultiE_JAT_v01.fig
%      SDVIEWER_MULTIE_JAT_V01, by itself, creates a new SDVIEWER_MULTIE_JAT_V01 or raises the existing
%      singleton*.
%
%      H = SDVIEWER_MULTIE_JAT_V01 returns the handle to a new SDVIEWER_MULTIE_JAT_V01 or the handle to
%      the existing singleton*.
%
%      SDVIEWER_MULTIE_JAT_V01('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SDVIEWER_MULTIE_JAT_V01.M with the given input arguments.
%
%      SDVIEWER_MULTIE_JAT_V01('Property','Value',...) creates a new SDVIEWER_MULTIE_JAT_V01 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SDViewer_MultiE_JAT_v01_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to SDViewer_MultiE_JAT_v01_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help SDViewer_MultiE_JAT_v01

% Last Modified by GUIDE v2.5 08-Dec-2015 09:23:13

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @SDViewer_MultiE_JAT_v01_OpeningFcn, ...
    'gui_OutputFcn',  @SDViewer_MultiE_JAT_v01_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before SDViewer_MultiE_JAT_v01 is made visible.
function SDViewer_MultiE_JAT_v01_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has noE1 output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to SDViewer_MultiE_JAT_v01 (see VARARGIN)

% Choose default command line output for SDViewer_MultiE_JAT_v01
...
% UIWAIT makes SDViewer_MultiE_JAT_v01 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = SDViewer_MultiE_JAT_v01_OutputFcn(hObject, eventdata, handles)
...
finalSaveLoc = strcat('E:\Dropbox\JohnAThompson_Matlab\SpikeDates2Cluster');
