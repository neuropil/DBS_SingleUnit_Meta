...
if ismember('ProcDone',dNchkN)
    ...
    if LFPcheck
        ...
        if exist('C1_DI001_Up','var')
            ...
            tsIndex_UP_E = ttl_revised_spTimes(CElectrode1, CElectrode1_KHz,...
                CElectrode1_TimeBegin, C1_DI001_KHz, C1_DI001_TimeBegin, ttlInfo.ttl_up);
            
            tsIndex_DN_E = ttl_revised_spTimes(CElectrode1, CElectrode1_KHz,...
                CElectrode1_TimeBegin, C1_DI001_KHz, C1_DI001_TimeBegin, ttlInfo.ttl_dn);
            
            tsIndex_UP_L = ttl_revised_spTimes(CLFP1, CLFP1_KHz,...
                CElectrode1_TimeBegin, C1_DI001_KHz, C1_DI001_TimeBegin, ttlInfo.ttl_up);
            
            tsIndex_DN_L = ttl_revised_spTimes(CLFP1, CLFP1_KHz,...
                CElectrode1_TimeBegin, C1_DI001_KHz, C1_DI001_TimeBegin, ttlInfo.ttl_dn);
            
            ttlInfo.ttl_upIe = tsIndex_UP_E;
            ttlInfo.ttl_dnIe = tsIndex_DN_E;
            
            ttlInfo.ttl_upIl = tsIndex_UP_L;
            ttlInfo.ttl_dnIl = tsIndex_DN_L;
