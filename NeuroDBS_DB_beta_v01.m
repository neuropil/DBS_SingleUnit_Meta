function [CellInfo] = NeuroDBS_DB_beta_v01(mouse,dateRec)
...
% Add Metric to determine if LFP was recorded
...
switch run_analysis
    ...
    case 1
        ...
        % Loop Through Clusters % FIX TRIALS TO USE
        trials2useCount = 1;
...
%             %%%%% FOR DEBUG
            ...
            allLeads = 1:4;
            disindex = allLeads(~ismember(allLeads,InactiveLeads));
