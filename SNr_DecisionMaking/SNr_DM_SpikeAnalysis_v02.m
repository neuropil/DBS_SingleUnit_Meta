function [] = SNr_DM_SpikeAnalysis_v02()
...
sNreyelistInd = cellfun(@(x) ismember(x(1:14),{'07302015_04493','07082015_00077'}), dirNames);
sNreyelistList = dirNames(sNreyelistInd);

% sumData = cell(length(sNreyelistList),1);
% for ii = 1:length(sNreyelistList)
%
%     cellnum = sNreyelistList{ii};
...
for cii = 1:length(sNreyelistList)
    
    load(sNreyelistList{cii})
